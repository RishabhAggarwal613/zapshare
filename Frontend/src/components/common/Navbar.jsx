...
const Button = ({ children, ...props }) => (
    <button
        {...props}
        className={`px-3 py-1 rounded bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 text-white font-semibold shadow hover:from-pink-600 hover:to-blue-600 transition-all duration-200 ${props.className}`}
    >
        {children}
    </button>
);
            ...
            <div className="container mx-auto px-4 py-4">
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            <h1 className="text-xl font-extrabold bg-gradient-to-r from-pink-400 via-purple-400 to-blue-400 bg-clip-text text-transparent">
                                ZapShare
                            </h1>
